...
class DepthwiseCrossViTMAE(nn.Module):
    def __init__(
        ...
        pad_top = desired_size - self.image_height
        pad_left = desired_size - self.image_width

        # Create padding layer
        self.pad = nn.ZeroPad2d((pad_left, 0, pad_top, 0))
    ...
    def forward(self, imgs: torch.Tensor):
        ...
        # Crop the output to original image size
        x = x[
            :,
            :,
            self.pad_top:,
